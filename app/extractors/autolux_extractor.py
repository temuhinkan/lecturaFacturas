...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.AutoluxExtractor", 
#
# Ejemplo (si el archivo generado es 'autolux_extractor.py'):
# "pinchete": "extractors.autolux_extractor.AutoluxExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'Importe', 'offset': +8, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a AutoluxExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class AutoluxExtractor:
