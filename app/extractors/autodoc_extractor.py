...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.AutodocExtractor", 
#
# Ejemplo (si el archivo generado es 'autodoc_extractor.py'):
# "pinchete": "extractors.autodoc_extractor.AutodocExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'FECHA':  {'type': 'VARIABLE', 'ref_text': 'Fecha de factura:', 'offset': 0, 'segment': 4},
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'Número de factura:', 'offset': 0, 'segment': 4},
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'AUTODOC SE'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'ESN0040262H'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'Total neto', 'offset': +1, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': '21% de IVA', 'offset': +1, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'Importe total bruto', 'offset': +1, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a AutodocExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class AutodocExtractor:
