...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.BrildorExtractor", 
#
# Ejemplo (si el archivo generado es 'brildor_extractor.py'):
# "pinchete": "extractors.brildor_extractor.BrildorExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'Brildor SL'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'Subtotal', 'offset': +1, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': 'IVA 21%', 'offset': +1, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'IVA 21%', 'offset': +3, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a BrildorExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class BrildorExtractor:
