...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.GuarnecidosExtractor", 
#
# Ejemplo (si el archivo generado es 'guarnecidos_extractor.py'):
# "pinchete": "extractors.guarnecidos_extractor.GuarnecidosExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'GUARNECIDOS TALLERES GARCIA S.L.'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'B·81084006'},
