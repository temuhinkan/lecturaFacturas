...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.KiautoExtractor", 
#
# Ejemplo (si el archivo generado es 'kiauto_extractor.py'):
# "pinchete": "extractors.kiauto_extractor.KiautoExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'FECHA':  {'type': 'VARIABLE', 'ref_text': 'Fecha Factura', 'offset': +5, 'segment': 1},
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'Factura', 'offset': +5, 'segment': 1},
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'AUTOLUX RECAMBIOS S.L'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'B02819530'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'Base', 'offset': +4, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': 'Cuota', 'offset': +4, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'TOTAL FACTURA', 'offset': +10, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a KiautoExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class KiautoExtractor:
