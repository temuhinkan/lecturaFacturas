...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.BeroilExtractor", 
#
# Ejemplo (si el archivo generado es 'beroil_extractor.py'):
# "pinchete": "extractors.beroil_extractor.BeroilExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'FACTURA NÚM:', 'offset': 0, 'segment': 2},
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'BEROIL, S.L.U'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'B09417957'},
    ...
    'IVA': {'type': 'VARIABLE', 'ref_text': 'IVA', 'offset': +7, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'TOTAL FACTURA', 'offset': +6, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a BeroilExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class BeroilExtractor:
