...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.AutolunasExtractor", 
#
# Ejemplo (si el archivo generado es 'autolunas_extractor.py'):
# "pinchete": "extractors.autolunas_extractor.AutolunasExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'AUTOLUNAS SAN BLAS'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': '50881826F'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'Bases de l. V.A.', 'offset': 3, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': 'Cuotas de 1.V.A.', 'offset': +3, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'TOTAL FACTURA', 'offset': +5, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a AdevintaExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class AutolunasExtractor:
