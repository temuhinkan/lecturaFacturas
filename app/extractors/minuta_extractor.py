...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.MinutaExtractor", 
#
# Ejemplo (si el archivo generado es 'minuta_extractor.py'):
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'Núm factura', 'offset': +2, 'segment': 1},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'TOTALES', 'offset': -3, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': 'TOTALES', 'offset': -1, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'TOTALES', 'offset': +3, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a MinutaExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class MinutaExtractor:
