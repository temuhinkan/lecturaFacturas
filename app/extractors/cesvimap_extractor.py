...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.CesvimapExtractor", 
#
# Ejemplo (si el archivo generado es 'cesvimap_extractor.py'):
# "pinchete": "extractors.cesvimap_extractor.CesvimapExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'Nº Factura:', 'offset': +16, 'segment': 1},
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'CENTRO DE EXPERIMENTACIÓN Y SEGURIDAD VIAL MAPFRE'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'A28272474'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'SUBTOTAL', 'offset': +6, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': 'IVA', 'offset': +5, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'SUBTOTAL', 'offset': +9, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a CesvimapExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class CesvimapExtractor:
