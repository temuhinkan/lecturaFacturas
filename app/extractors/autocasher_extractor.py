...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.AutocasherExtractor", 
#
# Ejemplo (si el archivo generado es 'autocasher_extractor.py'):
# "pinchete": "extractors.autocasher_extractor.AutocasherExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'FECHA':  {'type': 'VARIABLE', 'ref_text': 'FECHA...........:', 'offset': -4, 'segment': 1},
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'FACTURA Nº:', 'offset': -4, 'segment': 1},
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'AUTOCASHER PILAS, SL'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'B10754588'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'Base Imponible', 'offset': +1, 'segment': 1},
...
# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a AutocasherExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class AutocasherExtractor:
