...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.FielExtractor", 
#
# Ejemplo (si el archivo generado es 'fiel_extractor.py'):
# "pinchete": "extractors.fiel_extractor.FielExtractor",
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'FECHA':  {'type': 'VARIABLE', 'ref_text': 'Fecha', 'offset': +10, 'segment': 1},
    'NUM_FACTURA':  {'type': 'VARIABLE', 'ref_text': 'Nº Factura:', 'offset': +6, 'segment': "1-2"},
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'COMBUSTIBLES FIEL, S.L.'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'B84192483'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'Total', 'offset': +7, 'segment': 1},
    # IVA: 9 líneas arriba de 'Base Imponible'
    'IVA': {'type': 'VARIABLE', 'ref_text': 'Cuota IVA', 'offset': +10, 'segment': 1},
    # IMPORTE: 10 líneas arriba de 'Base Imponible'
    'IMPORTE': {'type': 'VARIABLE', 'ref_text': 'Total factura', 'offset': +1, 'segment': 1},
}

# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a FielExtractor
