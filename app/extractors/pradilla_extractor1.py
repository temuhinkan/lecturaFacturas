...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'FECHA': {'type': 'FIXED', 'segment': 2, 'line': 9},
    'NUM_FACTURA': {'type': 'FIXED', 'segment': 2, 'line': 8},
    ...
    'MATRICULA': {'type': 'FIXED', 'segment': 1, 'line': 22},
    'BASE': {'type': 'FIXED', 'segment': 1, 'line': 24},
    'IVA': {'type': 'FIXED', 'segment': 4, 'line': 25},
    'IMPORTE': {'type': 'FIXED', 'segment': 1, 'line': 35},
    'TASAS': {'type': 'FIXED', 'segment': 4, 'line': 30},
