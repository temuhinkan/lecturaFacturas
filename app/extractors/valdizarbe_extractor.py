...
#
# "nueva_clave": "extractors.nombre_archivo_extractor.ValdizarbeExtractor", 
#
# Ejemplo (si el archivo generado es 'valdizarbe_extractor.py'):
...
EXTRACTION_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    'EMISOR': {'type': 'FIXED_VALUE', 'value': 'RECUPERACIONES VALDIZARBE SL'},
    'CIF_EMISOR': {'type': 'FIXED_VALUE', 'value': 'B31275837'},
    ...
    'BASE': {'type': 'VARIABLE', 'ref_text': 'BASE IMPONIBLE', 'offset': +5, 'segment': 1},
...
# 🚨 CORRECCIÓN CRÍTICA: Renombrar la clase a ValdizarbeExtractor
# Asumimos que hereda de BaseInvoiceExtractor
class ValdizarbeExtractor:
